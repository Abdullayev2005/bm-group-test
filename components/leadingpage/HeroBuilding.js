...
const doors = [
  ...
  // { id: 3, name: 'Eshik 3', img: '/buil_image/eshik 3.png', top: '39%', left: '50%', width: 50, height: 140 },
  // { id: 4, name: 'Eshik 4', img: '/buil_image/eshik 4.png', top: '40%', left: '60%', width: 50, height: 140 },
  // { id: 5, name: 'Eshik 5', img: '/buil_image/eshik 5.png', top: '45%', left: '70%', width: 50, height: 140 },
  // { id: 6, name: 'Eshik 6', img: '/buil_image/eshik 6.png', top: '50%', left: '80%', width: 50, height: 140 },
];
    ...
    <div className="relative w-full h-[800px] overflow-hidden">
      ...
      {buildings.map(({ id, top, left, name, img, width, height }) => (
        <div
          ...
          className="absolute cursor-pointer group transition-transform duration-300 hover:scale-105"
        ...
        <div className="absolute bottom-0 left-0 w-full bg-white border-t z-20 p-6 animate-slideUp overflow-hidden">
          ...
          <div className="mt-4 relative w-full h-[600px] bg-gray-100 rounded shadow-inner overflow-hidden">
            ...
            {doors.map(({ id, img, top, left, name, width, height }) => (
              <div
                key={id}
                className="absolute cursor-pointer group transition-transform duration-300 hover:scale-110"
                onClick={() => setActiveDoor(id)}
                style={{ top, left, width: `${width}px`, height: `${height}px`, transform: 'translate(-50%, -50%)' }}
                >
                 <Image
                   src={img}
