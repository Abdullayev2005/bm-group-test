...
export default function InfoSection() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-12 space-y-4">
      {/* Yuqori blok */}
      <div className="flex flex-col-reverse md:flex-row items-center md:space-x-34">
        ...
        <div className="pr-4 w-full md:w-[400px] md:h-[180px]">
          <Image
            src={imageSrc}
            alt="Charx"
            width={300}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="pr-20 grid grid-cols-2 grid-rows-2 gap-2">
          {/* Bosh rasm: ikki qatorda baland */}
          <div className="row-span-2 w-[250px] h-[370px]">
            <Image
              src={imageSrc}
              alt="Charx"
              width={400}
          ...
          {/* Yuqori-o‘ng rasm */}
          <div className="pl-2 w-[240px] h-[180px]">
            <Image
              src={imageSrc}
              alt="Charx"
              width={280}
